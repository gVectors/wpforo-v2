...
<form action="" method="POST" class="validate">
    ...
    <input type="hidden" name="wpfaction" value="legal_options_save">
    <table class="wpforo_settings_table">
        ...
        <tr>
            <th style="padding-top: 10px;">
                ...
                <ul class="wpf-info" style="list-style: disc; padding: 5px 0 0 0; margin: 0 20px; line-height: 14px;">
        ...
        <tr>
            <th style="padding-top: 10px;" colspan="2">
                ...
                <div style="margin-top: ">
					...
					if( is_null( $value ) ) {
						$file  = WPFORO_DIR . '/admin/assets/html/privacy-policy-gdpr.html';
        ...
        <tr>
            <td colspan="2" style="border-bottom:3px solid #43A6DF; padding-top: 30px;">
                <h3 style="font-weight:600; padding:0; margin:0; color:#666666; font-size: 18px;">
        ...
        <tr>
            <th style="padding-top: 10px;" colspan="2">
                ...
                <div style="margin-top: ">
					...
					if( is_null( $value ) ) {
						$file  = WPFORO_DIR . '/admin/assets/html/simple-forum-rules.html';
						$value = wpforo_get_file_content( $file );
					}
					$args = [
						'teeny'         => false,
