    ...
    <form method="POST" class="validate">
        <div class="wpf-tool-box" style="margin-top: 15px;">
            <h3>
				...
				<?php else: ?>
                    [ <a href="<?php echo admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'tools' ) . '&tab=debug&view=tables' ) ?>" style="text-decoration: none; outline: none;box-shadow:none;"><?php _e( 'Tables', 'wpforo' ); ?></a> ]
				<?php endif; ?>
                                ...
                                <td style="padding-bottom: 50px;">
                                    <div style="font-size: 14px;">
                                        ...
                                        <div style="display:flex; flex-direction: row; justify-content: space-between; border-top: 1px dashed #cccccc; padding-top: 10px; text-align: right; margin-top: 10px; font-weight: normal; font-size: 13px;">
											<?php $update_db_url = wp_nonce_url( admin_url( 'admin.php?page=' . wpforo_prefix_slug( 'tools' ) . '&tab=debug&view=tables&wpfaction=database_update' ), 'wpforo_update_database' ); ?>
                                            <div>
