                                    ...
                                    <div class="form-field">
                                        ...
                                        <p>
											...
											<?php if( ! empty( $layouts ) ): ?>
                                                <select id="cat_layout" name="forum[cat_layout]" class="postform" <?php $data['cat_layout'] = ( isset( $data['cat_layout'] ) ? $data['cat_layout'] : 1 );
                                    ...
                                    <div id="wpf_forum_cover_field" style="padding: 10px; <?php echo ( $show_cover_field ? 'display: block' : 'display: none' ) ?>">
                                        ...
                                        <div id="wpf-forum-cover" style="background-image: url('<?php echo esc_url_raw( wpfval( $data, 'cover_url' ) ) ?>')">
			                                ...
			                                if( wpfval( $data, 'cover_url' ) ) {
				                                echo '<a href="#" id="wpf-forum-cover-remove" class="wpf-cat-cover-rmv button button-secondary">' . __('Remove image', 'wpforo') . '</a>
