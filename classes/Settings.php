...
class Settings {
		...
		$this->info->core = [
			...
			'components'    => [
				...
				"options"           => [
					...
					"copyright"      => [
						...
						"docurl"               => "https://wpforo.com/docs/wpforo-2/",
					],
				],
			],
			'forums'        => [
			...
			'topics'        => [
				...
				"options"           => [
					...
					"topic_head"                   => [
						"type"                 => "radio",
						"label"                => esc_html__( "Display Topic Staistics and Overview Panel", "wpforo" ),
						"label_original"       => "Display Topic Staistics and Overview Panel",
						"description"          => esc_html__( "", "wpforo" ),
						"description_original" => "",
						"docurl"               => "",
					],
					...
					"new_topic_notification_email_message" => [
						...
						"description"          => sprintf(
							'<ul class="wpf-email-shortcodes">
                               ...
                               <li>[topic_title] - %4$s</li>
                               <li>[topic_body] - %5$s</li>
						...
						"description_original" => "[user_display_name] - Subscriber display name [owner_display_name] - New topic author display name [forum_link] - Forum title / link [topic_title] - New topic title [topic_body] - New topic excerpt [unsubscribe_link] - Link to unsubscribe",
						"docurl"               => "",
					],
	...
	private function other( $group, $name, $value, $type = 'text' ) {
		...
		if( $type === 'float' ) {
			...
			$type = 'number';
			if( ! wpfkey( $info, 'info' ) ) {
				$info['info'] = __( 'Server "upload_max_filesize" is ' ) . $this->_SERVER['upload_max_filesize_human'] . '<br/>' . __( 'Server "post_max_size" is ' ) . $this->_SERVER['post_max_size_human'];
			}
		} elseif( $type === 'minute' ) {
			$type  = 'number';
	...
	private function richeditor( $group, $name, $value ) {
		...
		return sprintf(
			'<div class="wpf-opt-row" data-wpf-opt="%1$s">
                <table class="wpforo_settings_table wpforo-opt-richeditor">
