								...
								<?php if( $topic_url && ! empty( $member ) ): ?>
                                    <li class="<?php wpforo_unread( $topic['topicid'], 'topic' ) ?>">
                                        ...
                                        <div class="wpforo-last-topic-title">
											<?php wpforo_topic_title( $topic, $topic_url, '{p}{au}{tc}{/a}{n}', true, '', wpforo_setting( 'forums', 'layout_qa_intro_topics_length' ) ) ?><br/>
                                        ...
                                        <div class="wpforo-last-topic-posts wpfcl-2">
                                            <div class="count"><?php echo intval( $topic['posts'] ) ?></div>
                                            <div class="wpforo-label"><?php wpforo_phrase( 'replies' ) ?></div>
                                        </div>
                                    </li>
								<?php endif; ?>
							<?php endforeach; ?>
